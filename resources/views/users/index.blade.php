                ...
                <div class="mt-6 flex flex-wrap items-center gap-4">
                    ...
                    <div>
                        ...
                        <select name="active"
                            ...
                            <option value="1" {{ request('active') === '1' ? 'selected' : '' }}>Администратор</option>
                            <option value="0" {{ request('active') === '0' ? 'selected' : '' }}>Пользователь</option>
                        </select>
                    </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        @if(request()->hasAny(['name', 'email', 'date_from', 'date_to', 'active']))
