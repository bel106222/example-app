            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Добавление новой услуги сервисного центра
                    </p>
                </div>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="flex-1 space-y-4">
                                <div>
                                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                        Наименование услуги <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text"
                                           name="serviceName"
                                           id="serviceName"
                                           ...
                                           class="block w-full rounded-lg border-gray-300 dark:border-gray-600
                                              ...
                                              @error('serviceName') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                        ...
                        <div>
                            <label for="address" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                Описание услуги <span class="text-red-500">*</span>
                            </label>
                            <input type="text"
                                   name="serviceDescription"
                                   id="address"
                                   value="{{ old('serviceDescription') }}"
                                   required
                                   autocomplete="serviceDescription"
                                   class="block w-full rounded-lg border-gray-300 dark:border-gray-600
                                      dark:bg-gray-700 dark:text-white shadow-sm
                                      focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2.5
                                      @error('serviceDescription') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
